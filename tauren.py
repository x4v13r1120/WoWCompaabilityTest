...
# tauren-warrior,paladin,hunter,shaman,monk,druid,death knight,priest
def tauren_Classes():
    """
This is were the tauren class will be decided
    """
    wowClass = ['Warrior', 'Hunter', 'Paladin', 'Monk',
                'Shaman', 'Druid', 'Priest', 'Death knight']
    count = [0, 0, 0, 0, 0, 0, 0, 0]
    print("Tauren's are people of the land and band together in clans,\n "
