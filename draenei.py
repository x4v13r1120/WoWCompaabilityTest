...
# draenei-warrior,paladin, hunter,shaman,mage,monk,death knight,priest
def draenei_Classes():
    """
This is were the Draenei class will be decided
    """
    wowClass = ['Warrior', 'Hunter', 'Paladin', 'Mage',
                'Shaman', 'Monk', 'Priest', 'Death knight']
    count = [0, 0, 0, 0, 0, 0, 0, 0]
    print("Draenei are a rare race their numbers have dwindle in the wars of "
          "Azeroth but they are courageous warriors who stand by justice,\n "
