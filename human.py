...
def humanClasses():
    """
This is were the human class will be decided
    """
    wowClass = ['warrior', 'paladin', 'hunter', 'rouge', 'mage', 'warlock',
                'monk', 'priest', 'death knight']
    count = [0, 0, 0, 0, 0, 0, 0, 0, 0]
    print("Humans one of the more common races in Azeroth,\n"
          "as one you will be able to be a number of different classes.\n"
          "Warrior, Paladin, Hunter, Rouge, Mage, Warlock, Monk, Priest "
    ...
    if answer9 == "A":
        ...
        count[8] += 1
    print("You have most in common with ,", wowClass[count.index(max(count))])
